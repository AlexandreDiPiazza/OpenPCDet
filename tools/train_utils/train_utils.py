...
def train_one_epoch(model, optimizer, train_loader, model_func, lr_scheduler, accumulated_iter, optim_cfg,
    ...
    if grokfast_grads is not None:
        return accumulated_iter, grokfast_grads
...
def train_model(model, optimizer, train_loader, model_func, lr_scheduler, optim_cfg,
                ...
                train_with_grokfast=False):
    """
    We add the possibility to train with Grokfast, following this GitHub:
    https://github.com/ironjr/grokfast
    """
    if train_with_grokfast:
        grokfast_grads = None
    ...
    with tqdm.trange(start_epoch, total_epochs, desc='epochs', dynamic_ncols=True, leave=(rank == 0)) as tbar:
        ...
        for cur_epoch in tbar:
            ...
            if not train_with_grokfast:
                ...
                accumulated_iter, grokfast_grads= train_one_epoch(
                    model, optimizer, train_loader, model_func,
                    lr_scheduler=cur_scheduler,
                    accumulated_iter=accumulated_iter, optim_cfg=optim_cfg,
                    rank=rank, tbar=tbar, tb_log=tb_log,
